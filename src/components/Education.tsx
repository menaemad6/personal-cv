  ...
  return (
    <section className="py-6">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-6 text-primary border-b pb-2">Education</h2>
        <div className="space-y-6">
          <div className="mb-6">
            ...
            <p className="text-gray-700 mt-1">First Year Student (Expected graduation: 2028)</p>
